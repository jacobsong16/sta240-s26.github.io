...
Just as the [derivative](https://anyakatsevich.github.io/sta240-s26.github.io/math/differentiation.html) is the continuous analog to a discrete difference, the integral is the continuous analog to a discrete sum. 
...
$$
What function, when you take its derivative, gives you $1/x^2=x^{-2}$? To answer that, you're essentially *undoing* the [power rule](https://anyakatsevich.github.io/sta240-s26.github.io/math/differentiation.html#derivative-rules). After a while, you realize
$$
