---
title: "Lab 1: hello R"
subtitle: Due Thursday January 15 at 11:59 PM
editor: 
  mode: source
---
...
1. [Getting into RStudio](https://anyakatsevich.github.io/sta240-s26.github.io/explainers/setup.html);
1. [Understanding the RStudio layout](https://anyakatsevich.github.io/sta240-s26.github.io/explainers/hello-rstudio.html);
1. [Creating your lab write-ups with Quarto](https://anyakatsevich.github.io/sta240-s26.github.io/explainers/quarto.html);
1. [Typing up pretty equations with Quarto](https://anyakatsevich.github.io/sta240-s26.github.io/explainers/latex.html);
1. [Using `R` as a big calculator](https://anyakatsevich.github.io/sta240-s26.github.io/explainers/math.html);
1. [Introduction to vectors](https://anyakatsevich.github.io/sta240-s26.github.io/explainers/vectors.html);
1. [Plotting line graphs with the `curve` function](https://anyakatsevich.github.io/sta240-s26.github.io/explainers/lineplot.html);
1. [Simulating random experiments with the `sample` function](https://anyakatsevich.github.io/sta240-s26.github.io/explainers/sample.html);
1. [if-else and logical operations](https://anyakatsevich.github.io/sta240-s26.github.io/explainers/if-else.html);
1. [for loops](https://anyakatsevich.github.io/sta240-s26.github.io/explainers/loops.html);
1. [Vectorization](https://anyakatsevich.github.io/sta240-s26.github.io/explainers/vectorization.html).

Please dip into those as needed.

To use R/RStudio, you can either use the Duke Container Manager or download the necessary applications here. Note: The R/RStudio in the containers comes with `TinyTeX` already downloaded. So, if you download the application and want to use LaTeX in your files, run the following command (and whatever subsequent commands you are prompted to run) in the console at the bottom of your RStudio window:
...
::: callout-tip
## Once is enough
If you've run the above command once, you don't need to worry about running it again every time you use RStudio.
:::
...
Go to the files in Canvas and download the blank Quarto file you will use to create your write-up. Once you have this file, upload it to your container or local RStudio and get crackin'!
:::
...
Imagine you roll two *fair* dice. What is the probability that the sum of the two numbers you roll is even? To approximate this, work together with the TA to complete the following steps:
...
There are many correct ways to do this, but you might find the [`any`](https://stat.ethz.ch/R-manual/R-devel/library/base/html/any.html) function helpful. Additionally, the `%in%` operator may be of some use; observe the following outputs:
