...
In the [last lecture](https://anyakatsevich.github.io/sta240-s26.github.io/lecture-notes/sta240-notes-14-sums-and-averages.pdf), we studied iid collections of several random variables:
...
On [Problem Set 6](https://anyakatsevich.github.io/sta240-s26.github.io/problems/pset-6.html#problem-2), you studied the position $X_n$ of a one-dimensional subatomic particle in energy state $n$ on the interval $[0,\,L]$. It had cumulative distribution function
...
The limit we took to finish the proof is basically the same limit you took on [Problem Set 0 problem 6](https://anyakatsevich.github.io/sta240-s26.github.io/problems/pset-0.html#problem-6). Just take $x=n$ and $f=\ln M$.
:::
