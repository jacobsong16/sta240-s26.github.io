...
Below are two complete, worked examples of maximum likelihood problems. You also have the solutions to [Lab 10](https://anyakatsevich.github.io/sta240-s26.github.io/labs/lab-10.html). The final exam will feature a problem with exactly the same format as these three examples, so study them carefully. The steps are as follows:
...
Step 1 requires you to be fluent with algebraic manipulations from pre-calculus, especially your log and exponent properties. Step 2 requires you to be fluent in your derivative rules. Step 3 requires you to to be fluent with [change-of-variables](https://anyakatsevich.github.io/sta240-s26.github.io/labs/lab-7.html) and [sums and averages](https://anyakatsevich.github.io/sta240-s26.github.io/lecture-notes/sta240-notes-14-sums-and-averages.pdf) of iid random variables. As such, these problems synthesize a lot of the technical skills that you will need in future statistical theory courses. Furthermore, the steps are cumulative. You can't do Step 3 correctly if you muck up Steps 1 and 2. So, to ace the final, you need to get your arms around the entire process. 
...
This is a random variable because it depends on the $X_i$, which are random. We know that $X_i\overset{\text{iid}}{\sim}\text{Gamma}(1,\,\theta)$ and so we know from [lecture](https://anyakatsevich.github.io/sta240-s26.github.io/lecture-notes/sta240-notes-14-sums-and-averages.pdf) that $\bar{X}_n\sim\text{Gamma}(n,\,n\theta)$. Consequently, the distribution of $\hat{\theta}_n=1/\bar{X}_n$ is [*inverse gamma*](https://anyakatsevich.github.io/sta240-s26.github.io/distributions/continuous-inverse-gamma.html), which you derived on [Problem Set 6 #6d](https://anyakatsevich.github.io/sta240-s26.github.io/problems/pset-6.html#problem-6). 
...
This is a special case of the family you studied on [Problem Set 6 #1](https://anyakatsevich.github.io/sta240-s26.github.io/problems/pset-6.html#problem-1), and you also worked with it on Midterm 2. 
