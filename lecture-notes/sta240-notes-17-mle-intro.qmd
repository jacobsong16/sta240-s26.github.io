...
In the app above you can perform the maximization by eye, but in general we do it mathematically. In other words, we reduce the problem of estimation to a Calc 1 problem: take the derivative, set it equal to zero, solve for the critical points, classify them using the second derivative test, all that jazz. See [here](https://anyakatsevich.github.io/sta240-s26.github.io/math/differentiation.html#optimization) if you want a refresher on how that goes.
