...
- sometimes, the geometric distribution is used to count the number of trials you must wait through until the first success. The range is $\{1,\,2,\,3,\,4,\,...\}$ and the PMF is $P(X=k)=(1-p)^{k-1}p$. This is what we saw in [lecture](https://anyakatsevich.github.io/sta240-s26.github.io/lecture-notes/sta240-notes-06-discrete-families.pdf);
