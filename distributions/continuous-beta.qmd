...
Every probability density is an [integral identity in disguise](https://anyakatsevich.github.io/sta240-s26.github.io/math/massage-and-squint.html#kernel-tricks), so we have that:
...
This is classic "massage and squint." We do a kernel-trick with the beta density, and we recall the properties of the gamma function from [Problem Set 0](https://anyakatsevich.github.io/sta240-s26.github.io/problems/pset-0.html#problem-5).
