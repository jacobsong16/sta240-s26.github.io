...
Notice that we made use of the fact that the `dbinom` command is [*vectorized*](https://anyakatsevich.github.io/sta240-s26.github.io/explainers/vectorization.html) in its first argument; if you give it a vector with multiple values, it returns a vector with the probabilities for each one.
